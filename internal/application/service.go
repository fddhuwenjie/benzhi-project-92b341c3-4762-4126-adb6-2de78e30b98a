...
func (s *Service) execute(batchID string, meta CommandMeta, command any, create bool, mutate store.Mutation) (CommandResponse, error) {
	return s.executeContext(context.Background(), batchID, meta, command, create, mutate)
}

func (s *Service) executeContext(ctx context.Context, batchID string, meta CommandMeta, command any, create bool, mutate store.Mutation) (CommandResponse, error) {
